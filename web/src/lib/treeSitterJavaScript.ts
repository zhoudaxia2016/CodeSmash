...
const CAPTURE_STYLE: Record<string, string> = {
  keyword: 'color:hsl(258 82% 74%)',
  string: 'color:hsl(142 55% 58%)',
  'string.special': 'color:hsl(142 55% 58%)',
  embedded: 'color:hsl(168 60% 62%)',
  comment: 'color:hsl(240 6% 52%);font-style:italic',
  number: 'color:hsl(32 90% 68%)',
  operator: 'color:hsl(340 70% 72%)',
  'function.method': 'color:hsl(210 75% 72%)',
  function: 'color:hsl(210 75% 72%)',
  'function.builtin': 'color:hsl(210 75% 72%)',
  constructor: 'color:hsl(45 88% 68%)',
  'variable.builtin': 'color:hsl(280 65% 72%)',
  'constant.builtin': 'color:hsl(280 65% 72%)',
  constant: 'color:hsl(45 88% 68%)',
  'punctuation.special': 'color:hsl(240 8% 72%)',
  'punctuation.bracket': 'color:hsl(240 8% 72%)',
  'punctuation.delimiter': 'color:hsl(240 8% 72%)',
  property: 'color:hsl(195 70% 72%)',
