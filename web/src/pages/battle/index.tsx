...
import { loadBattleSetupPrefs, saveBattleSetupPrefs } from '@/pages/battle/lib/battle-setup-prefs'
import { readBattleDetailIdFromUrl } from '@/pages/battle/lib/battle-url'
...
import { getLocalBattleEntry } from '@/pages/battle/lib/battle-local-history'
